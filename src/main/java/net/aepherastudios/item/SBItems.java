...
public class SBItems {
    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, StarsBeyond.MOD_ID);
    ...
    public static final RegistryObject<Item> CAESIUM_INGOT = ITEMS.register("caesium_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> CALCIUM_INGOT = ITEMS.register("calcium_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> CHROMIUM_INGOT = ITEMS.register("chromium_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> CERIUM_INGOT = ITEMS.register("cerium_ingot", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> CUPRONICKEL_INGOT = ITEMS.register("cupronickel_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> DYSPROSIUM_INGOT = ITEMS.register("dysprosium_ingot", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> PLUTONIUM_238_INGOT = ITEMS.register("plutonium_238_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> PLUTONIUM_239_INGOT = ITEMS.register("plutonium_239_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> POTASSIUM_INGOT = ITEMS.register("potassium_ingot", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> URANIUM_239_INGOT = ITEMS.register("uranium_239_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> FUEL_GRADE_URANIUM = ITEMS.register("fuel_grade_uranium", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> WEAPONS_GRADE_URANIUM = ITEMS.register("weapons_grade_uranium", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> SMALL_NUCLEAR_WARHEAD = ITEMS.register("small_nuclear_warhead", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> SMALL_THERMONUCLEAR_WARHEAD = ITEMS.register("small_thermonuclear_warhead", () -> new Item(new Item.Properties()));
